<div class="row box-row">
    <div class="col-3 name-file">
        ...
        <ul class="dropdown-menu">
            <li dataid="{{ $dataId }}"><i class="bi bi-pencil-square text-primary me-2 ms-2"></i>Rename</li>
            <li><hr class="dropdown-divider"></li>
            <li dataid="{{ $dataId }}"><i class="bi bi-trash3 text-danger me-2 ms-2"></i>Delete</li>
        </ul>
