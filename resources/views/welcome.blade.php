                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent d-flex">
                            ...
                            @else
                                <li class="nav-item mr-2">
                                    <a href="{{ route('login') }}" class="nav-link text-white bg-navy rounded-2"><i class="bi bi-box-arrow-in-right me-1 text-white"></i> Log in</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('register') }}" class="nav-link text-white bg-navy rounded-2"><i class="bi bi-person-plus me-1 text-white"></i>Register</a>
                                </li>
                            @endauth
                            </ul>
                        </div>
